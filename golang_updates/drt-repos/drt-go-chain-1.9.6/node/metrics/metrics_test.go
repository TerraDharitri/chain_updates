...
func TestInitConfigMetrics(t *testing.T) {
	...
	expectedValues := map[string]interface{}{
		...
		"drt_esdt_enable_epoch":                                                uint32(17),
		...
		"drt_esdt_register_and_set_all_roles_enable_epoch":                     uint32(56),
		...
		"drt_esdt_metadata_continuous_cleanup_enable_epoch":                    uint32(68),
		...
		"drt_dynamic_esdt_enable_epoch":                                        uint32(100),
		...
		"drt_multi_esdt_transfer_execute_by_user_enable_epoch":                 uint32(105),
		...
		"drt_relayed_transactions_v3_fix_esdt_transfer_enable_epoch":           uint32(108),
