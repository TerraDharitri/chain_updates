...
func TestNFTTransferCrossShardWithSCCall(t *testing.T) {
	...
	tx := &transaction.Transaction{
		...
		GasLimit: 150000000,
		GasPrice: 1000000000,
		Data:     []byte("DCDTNFTTransfer@4c4b4641524d2d336634663962@016534@6f1e6f01bc7627f5ae@00000000000000000500f1c8f2fdc58a63c6b201fc2ed629962d3dfa33fe7ceb@636f6d706f756e645265776172647350726f7879@000000000000000005004f79ec44bb13372b5ac9d996d749120f476427627ceb"),
		Value:    big.NewInt(0),
	}
...
func TestNFTTransferCrossShard(t *testing.T) {
	...
	tx := &transaction.Transaction{
		...
		GasLimit: 5000000,
		GasPrice: 1000000000,
		Data:     []byte("DCDTNFTTransfer@536f6d657468696e672d616263646566@01@01@00000000000000000500a7a02771aa07090e607f02b25f4d6d241bff32b990a2"),
		Value:    big.NewInt(0),
	}
...
func TestNFTTransferCrossShardImportDBScenarioFirstIndexDestinationAfterSource(t *testing.T) {
	...
	scr2 := &smartContractResult.SmartContractResult{
		...
		SndAddr:        decodeAddress(address1),
		RcvAddr:        decodeAddress(address2),
		Data:           []byte("DCDTNFTTransfer@434f4c4c454354494f4e2d323663313838@01@01@"),
		PrevTxHash:     txHash,
		OriginalTxHash: txHash,
	}
	...
	tx := &transaction.Transaction{
		...
		GasLimit: 5000000,
		GasPrice: 1000000000,
		Data:     []byte("DCDTNFTTransfer@434f4c4c454354494f4e2d323663313838@01@01@00000000000000000500a7a02771aa07090e607f02b25f4d6d241bff32b990a2"),
		Value:    big.NewInt(0),
	}
