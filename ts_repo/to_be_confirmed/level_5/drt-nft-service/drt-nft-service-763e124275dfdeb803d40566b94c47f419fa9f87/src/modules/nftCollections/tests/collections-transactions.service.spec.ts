...
describe('Collections Transactions Service', () => {
  ...
  describe('setNftRoles', () => {
    it('returns built transaction with right arguments', async () => {
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'c2V0U3BlY2lhbFJvbGVANjM2ZjZjNmM2NTYzNzQ2OTZmNmVANmUyMjQxMThkOTA2OGFlNjI2ODc4YTFjZmJlYmNiNmE5NWE0NzE1ZGI4NmQxYjUxZTA2YTA0MjI2Y2YzMGZkNkA0NDQzNDQ1NDUyNmY2YzY1NGU0NjU0NDE2NDY0NTE3NTYxNmU3NDY5NzQ3OQ==',
        gasLimit: 60267500,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
