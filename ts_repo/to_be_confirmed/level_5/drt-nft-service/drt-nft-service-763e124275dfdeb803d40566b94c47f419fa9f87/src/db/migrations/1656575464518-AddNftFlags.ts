...
export class AddNftFlags1656575464518 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`nft_flags\` (\`id\` int NOT NULL AUTO_INCREMENT, \`identifier\` varchar(25) NOT NULL, \`nsfw\` decimal(6,2) NOT NULL, INDEX \`IDX_37a67b537f8fe7c75e404c86e4\` (\`identifier\`), UNIQUE INDEX \`NftFlagsEntity_UQ_Flag\` (\`identifier\`, \`nsfw\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
  }
