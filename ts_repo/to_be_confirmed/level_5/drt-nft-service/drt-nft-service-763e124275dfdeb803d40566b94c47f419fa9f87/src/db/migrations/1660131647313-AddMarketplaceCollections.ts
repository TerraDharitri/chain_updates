...
export class AddMarketplaceCollections1660131647313 implements MigrationInterface {
  name = 'AddMarketplaceCollections1660131647313';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX \`marketplace_address\` ON \`featured_marketplaces\``);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX \`marketplace_collection\` ON \`marketplace-collections\``);
    await queryRunner.query(`DROP TABLE \`marketplace-collections\``);
    await queryRunner.query(`DROP INDEX \`marketplace_address\` ON \`marketplaces\``);
