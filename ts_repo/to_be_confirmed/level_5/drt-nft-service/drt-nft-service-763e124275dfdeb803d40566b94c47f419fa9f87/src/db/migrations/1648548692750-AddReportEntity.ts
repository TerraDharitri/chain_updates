...
export class AddReportEntity1648548692750 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`report_nfts\` (\`id\` int NOT NULL AUTO_INCREMENT, \`identifier\` varchar(25) NOT NULL, \`address\` varchar(62) NOT NULL, INDEX \`IDX_22d52a1ff52468314f1a088c1d\` (\`identifier\`), UNIQUE INDEX \`ReportNftEntity_UQ_REPORT\` (\`identifier\`, \`address\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
  }
