...
export class AddFeaturedCollection1644936758636 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`featured_collections\` (\`id\` int NOT NULL AUTO_INCREMENT, \`identifier\` varchar(25) NOT NULL, INDEX \`IDX_70200621f1cff27f7717c3d707\` (\`identifier\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
  }
