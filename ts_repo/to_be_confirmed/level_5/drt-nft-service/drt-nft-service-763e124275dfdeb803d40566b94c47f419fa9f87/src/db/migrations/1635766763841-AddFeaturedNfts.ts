...
export class AddFeaturedNfts1635766763841 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE `featured_nfts` (`id` int NOT NULL AUTO_INCREMENT, `identifier` varchar(25) NOT NULL, INDEX `IDX_e18b70f57ae7ca3c2ac8774aa6` (`identifier`), PRIMARY KEY (`id`)) ENGINE=InnoDB',
    );
  }
