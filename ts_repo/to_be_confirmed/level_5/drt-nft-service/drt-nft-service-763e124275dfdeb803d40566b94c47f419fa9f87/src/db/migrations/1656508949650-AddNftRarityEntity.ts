...
export class AddNftRarityEntity1656508949650 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX \`NftRarityEntity_UQ_RARITY\` ON \`nft_rarities\``);
    await queryRunner.query(`DROP INDEX \`rarity_identifier\` ON \`nft_rarities\``);
    await queryRunner.query(`DROP INDEX \`rarity_collection\` ON \`nft_rarities\``);
