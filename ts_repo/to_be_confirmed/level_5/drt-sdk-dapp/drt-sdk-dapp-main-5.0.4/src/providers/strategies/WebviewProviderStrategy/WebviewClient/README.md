...
1. The **parent dApp** logs in with the Dharitri Web Wallet using Native Auth.
...
```ts
### Usage example
import { WebviewClient } from '@terradharitri/sdk-dapp/out/providers/strategies/WebviewProviderStrategy/WebviewClient';
...
<iframe
  ...
  src={"https://devnet.template-dapp.dharitri.org/"}
/>
```
