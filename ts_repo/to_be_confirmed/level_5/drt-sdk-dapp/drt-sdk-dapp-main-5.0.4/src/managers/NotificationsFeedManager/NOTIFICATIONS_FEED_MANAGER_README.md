...
### Import
```typescript
import { NotificationsFeedManager } from '@terradharitri/sdk-dapp/out/managers/NotificationsFeedManager/NotificationsFeedManager';
```
...
- The feed is implemented as a side panel web component (`DrtNotificationsFeed`).
...
- [DrtNotificationsFeed](https://github.com/TerraDharitri/drt-sdk-dapp-ui): The UI component rendered by the manager.
