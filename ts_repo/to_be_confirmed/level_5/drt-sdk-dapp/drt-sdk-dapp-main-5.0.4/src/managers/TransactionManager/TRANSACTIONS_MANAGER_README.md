...
The `TransactionManager` is a singleton class responsible for sending, tracking, and managing the lifecycle of transactions in the Dharitri dApp ecosystem. It provides a high-level API for handling both single and batch transactions, tracking their status, and integrating with UI feedback mechanisms such as toast notifications.
