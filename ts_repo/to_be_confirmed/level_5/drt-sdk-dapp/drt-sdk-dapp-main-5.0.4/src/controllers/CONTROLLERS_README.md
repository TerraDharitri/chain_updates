...
import type { DrtTransactionsTable as DrtTransactionsTablePropsType } from '@terradharitri/sdk-dapp-ui/web-components/drt-transactions-table';
...
export const TransactionsTable = ({
  ...
  return <DrtTransactionsTable transactions={processedTransaction} />;
};
```
