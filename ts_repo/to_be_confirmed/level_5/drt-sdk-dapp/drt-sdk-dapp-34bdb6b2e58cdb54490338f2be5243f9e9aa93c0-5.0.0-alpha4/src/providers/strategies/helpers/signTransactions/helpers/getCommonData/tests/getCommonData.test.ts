    ...
    expect(commonData).toStrictEqual({
      commonData: {
        ...
        decodedData: {
          ...
          decimal: {
            displayValue:
              'MultiDCDTNFTTransfer@122606984161813630683000759836492172880332059259659648235@2@27024655224515989844372174137@@1000000000000000000@365084208479657602409520@@1064735712967374589014278@30141412180830754292089058425@990000000000000000@1054088355837700843124135',
            validationWarnings: [],
            highlight:
