...
import { DrtApiService, MxStatsService } from 'src/common';
import { Asset } from '../assets/models';

@Injectable()
export class TrendingService {
  constructor(private apiService: DrtApiService, private statsService: MxStatsService, private readonly logger: Logger) {}
