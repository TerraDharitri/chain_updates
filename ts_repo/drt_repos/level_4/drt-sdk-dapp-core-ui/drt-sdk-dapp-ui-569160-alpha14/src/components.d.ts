...
export namespace Components {
    ...
    interface DrtPendingTransactionsPanel {
        /**
          * @default {     isPending: false,     title: '',     subtitle: '',   }
         */
    ...
    interface DrtSignTransactionsPanel {
        /**
          * @default {     commonData: {       rewaLabel: '',       feeLimit: '',       feeInFiatLimit: '',       transactionsCount: 0,       currentIndex: 0,       ppuOptions: [],     },     tokenTransaction: null,     nftTransaction: null,     sftTransaction: null,   }
         */
    ...
    interface DrtUnlockProviderIntro {
        /**
          * @default null
         */
...
export interface DrtUnlockProviderIntroCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLDrtUnlockProviderIntroElement;
}
declare global {
    ...
    interface HTMLDrtUnlockProviderIntroElementEventMap {
        "access": any;
    }
    interface HTMLDrtUnlockProviderIntroElement extends Components.DrtUnlockProviderIntro, HTMLStencilElement {
        addEventListener<K extends keyof HTMLDrtUnlockProviderIntroElementEventMap>(type: K, listener: (this: HTMLDrtUnlockProviderIntroElement, ev: DrtUnlockProviderIntroCustomEvent<HTMLDrtUnlockProviderIntroElementEventMap[K]>) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener<K extends keyof DocumentEventMap>(type: K, listener: (this: Document, ev: DocumentEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener<K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
        removeEventListener<K extends keyof HTMLDrtUnlockProviderIntroElementEventMap>(type: K, listener: (this: HTMLDrtUnlockProviderIntroElement, ev: DrtUnlockProviderIntroCustomEvent<HTMLDrtUnlockProviderIntroElementEventMap[K]>) => any, options?: boolean | EventListenerOptions): void;
        removeEventListener<K extends keyof DocumentEventMap>(type: K, listener: (this: Document, ev: DocumentEventMap[K]) => any, options?: boolean | EventListenerOptions): void;
        removeEventListener<K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | EventListenerOptions): void;
        removeEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | EventListenerOptions): void;
    }
    var HTMLDrtUnlockProviderIntroElement: {
        prototype: HTMLDrtUnlockProviderIntroElement;
        new (): HTMLDrtUnlockProviderIntroElement;
    };
    ...
    interface HTMLElementTagNameMap {
        ...
        "drt-unlock-provider-intro": HTMLDrtUnlockProviderIntroElement;
...
declare namespace LocalJSX {
    ...
    interface DrtUnlockProviderIntro {
        "onAccess"?: (event: DrtUnlockProviderIntroCustomEvent<any>) => void;
        /**
          * @default null
         */
        "provider"?: IProviderBase | null;
    ...
    interface IntrinsicElements {
        ...
        "drt-unlock-provider-intro": DrtUnlockProviderIntro;
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "drt-unlock-provider-intro": LocalJSX.DrtUnlockProviderIntro & JSXBase.HTMLAttributes<HTMLDrtUnlockProviderIntroElement>;
