...
export class LedgerFlow {
  ...
  render() {
    ...
    if (this.data.confirmScreenData) {
      return <drt-ledger-confirm confirmScreenData={this.data.confirmScreenData} />;
    }

    return <drt-ledger-intro connectScreenData={this.data.connectScreenData} onConnect={this.handleIntroConnect.bind(this)} />;
  }
}
