...
const signScreens = {
  FungibleDCDT: 'drt-token-component',
  SemiFungibleDCDT: 'drt-fungible-component',
  NonFungibleDCDT: 'drt-fungible-component',
  MetaDCDT: 'drt-token-component',
};
...
export class SignTransactionsPanel {
  ...
  render() {
    ...
    return (
      <drt-side-panel isOpen={this.isOpen} panelClassName="sign-transactions-panel" onClose={this.handleClose.bind(this)}>
