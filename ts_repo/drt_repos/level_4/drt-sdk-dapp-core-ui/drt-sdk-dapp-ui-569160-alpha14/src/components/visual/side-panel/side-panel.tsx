      ...
      >
        <div class={classNames('side-panel', { visible: this.shouldAnimate }, this.panelClassName)}>
          <div class="side-panel-heading">
            {this.withBackButton && <drt-back-arrow-icon onClick={this.handleBackClick.bind(this)} class="side-panel-heading-back" />}
            <div class="side-panel-heading-title">{this.panelTitle}</div>
            <drt-close-icon class="side-panel-heading-close" onClick={this.handleCloseClick.bind(this)} />
          </div>
