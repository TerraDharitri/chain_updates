  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          {this.isIntroScreenVisible && <drt-unlock-provider-intro provider={this.selectedMethod} onAccess={this.handleAccess.bind(this)} />}
        </div>
                ...
                <div class="unlock-panel-group">
                  ...
                  <div class="unlock-panel-group-providers">
                    {detectedProviders.map(provider => (
                      <drt-unlock-provider-button provider={provider} onClick={this.handleLogin.bind(this, provider)} />
                    ))}
                  </div>
                </div>
              )}
