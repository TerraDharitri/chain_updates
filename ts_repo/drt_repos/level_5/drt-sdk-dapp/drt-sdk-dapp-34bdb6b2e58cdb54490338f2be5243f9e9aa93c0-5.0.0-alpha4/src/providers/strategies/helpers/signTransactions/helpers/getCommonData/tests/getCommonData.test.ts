...
jest.mock('methods/network/getExplorerAddress', () => ({
  getExplorerAddress: jest.fn(() => 'http://devnet-explorer.dharitri.org')
}));
  ...
  it('should return the common data with ppu for second transaction', async () => {
    ...
    expect(commonData).toStrictEqual({
      commonData: {
        currentIndex: 3,
        currentIndexToSign: 0,
        data: 'MultiDCDTNFTTransfer@00000000000000000500139ed7ae4aa03792e6bcb332394a40fe746eefa47ceb@02@57524557412d613238633539@@0de0b6b3a7640000@4d45582d613635396430@@e177704bc43f9bee3106@6164644c6971756964697479@0dbd2fc137a30000@df363e8872ed0d9235a7',
        rewaLabel: 'xREWA',
        ...
        decodedData: {
          raw: {
            displayValue:
              'MultiDCDTNFTTransfer@00000000000000000500139ed7ae4aa03792e6bcb332394a40fe746eefa47ceb@02@57524557412d613238633539@@0de0b6b3a7640000@4d45582d613635396430@@e177704bc43f9bee3106@6164644c6971756964697479@0dbd2fc137a30000@df363e8872ed0d9235a7',
            validationWarnings: [],
            highlight:
          ...
          decimal: {
            displayValue:
              'MultiDCDTNFTTransfer@122606984161813630683000759836492172880332059259659648235@2@27008948430895953375700137273@@1000000000000000000@364901398363583379235888@@1064735712967374589014278@30141412180830754292089058425@990000000000000000@1054088355837700843124135',
            validationWarnings: [],
            highlight:
