    ...
    const mockTokens = [
      {
        ...
        assets: {
          ...
          description: "wEGLD is an ESDT token that has the same value as EGLD, the native coin of the DharitrI blockchain.",
  ...
  describe('getTokenAccounts', () => {
    ...
    const assets = {
      erd16jruked88jgtsar78ej85hjp3qsd9jkjcw4swsn7k0teqh3wgcqqgyrupq: new AccountAssets({
        ...
        tags: ['exchange', 'tests'],
        iconPng:
          'https://raw.githubusercontent.com/dharitri/mx-assets/master/accounts/icons/test.png',
        iconSvg:
          'https://raw.githubusercontent.com/dharitri/mx-assets/master/accounts/icons/test.svg',
      }),
    };
