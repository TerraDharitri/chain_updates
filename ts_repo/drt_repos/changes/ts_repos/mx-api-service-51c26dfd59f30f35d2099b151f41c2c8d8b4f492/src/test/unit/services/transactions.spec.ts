  ...
  describe('getTransactions', () => {
    ...
    const assetsAccountMock = {
      'account': new AccountAssets({
        name: 'Test',
        description: 'Test',
        icon: 'https://raw.githubusercontent.com/dharitri/mx-assets/master/accounts/icons/dharitri.png',
        iconPng: 'https://raw.githubusercontent.com/dharitri/mx-assets/master/accounts/icons/dharitri.png',
        iconSvg: 'https://raw.githubusercontent.com/dharitri/mx-assets/master/accounts/icons/dharitri.png',
        proof: '',
