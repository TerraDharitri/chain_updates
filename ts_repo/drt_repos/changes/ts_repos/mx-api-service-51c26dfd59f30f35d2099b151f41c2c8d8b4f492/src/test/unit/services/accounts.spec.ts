    ...
    const assets: { [key: string]: AccountAssets } = {
      erd1qqqqqqqqqqqqqpgqc0htpys8vhtf5m3tg7t6ts2wvkgx3favqrhsdsz9w0: {
        ...
        social: new AccountAssetsSocial({
          ...
          blog: "https://dharitri.org/blog/maiar-exchange-mex-tokenomics",
        }),
        tags: ['dns'],
        icon: 'dharitri',
        iconPng: '',
  ...
  describe('getAccounts', () => {
    ...
    const assets: { [key: string]: AccountAssets } = {
      erd1qqqqqqqqqqqqqpgqykt0f03czqj2p9qltpygzu7jwlzkaxqaqpdq07cak6: {
        ...
        iconSvg: "https://raw.githubusercontent.com/dharitri/mx-assets/master/accounts/icons/dharitri.svg",
        icon: '',
        proof: '',
        social: undefined,
      },
