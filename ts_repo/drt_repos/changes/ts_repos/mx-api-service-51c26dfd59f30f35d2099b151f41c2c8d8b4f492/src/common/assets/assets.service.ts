...
export class AssetsService {
  ...
  createAccountAsset(name: string, tags: string[]): AccountAssets {
    return new AccountAssets({
      name: name,
      tags: tags,
      iconSvg: 'https://raw.githubusercontent.com/dharitri/mx-assets/master/accounts/icons/xexchange.svg',
      iconPng: 'https://raw.githubusercontent.com/dharitri/mx-assets/master/accounts/icons/xexchange.png',
    });
  }
}
