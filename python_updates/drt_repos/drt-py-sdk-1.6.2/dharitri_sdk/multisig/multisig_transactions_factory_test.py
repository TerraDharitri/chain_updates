...
class TestMultisigTransactionsFactory:
    ...
    def test_deposit_native_and_dcdt(self):
        ...
        assert (
            transaction.data.decode()
            == f"MultiDCDTNFTTransfer@{contract.to_hex()}@03@4142434445462d313233343536@@0186a0@58595a5157452d393837363534@07@01@524557412d303030303030@@0de0b6b3a7640000@6465706f736974"
        )
    ...
    def test_propose_async_delegate_vote(self):
        alice = Address.new_from_bech32("drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf")
        multisig = Address.new_from_bech32("drt1qqqqqqqqqqqqqpgq6kurkz43xq8t35kx9p8rvyz5kpxe9g7qd8ssy4h3de")
        contract = Address.new_from_bech32("drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqrlllsf45f4t")
        ...
        assert (
            transaction.data.decode()
            == "proposeAsyncCall@233300000000000000000000000000000002333000000000000000000003ffff@@0100000000004c4b40@64656c6567617465566f7465@01@796573@0139472eff6886771a982f3083da5d421f24c29181e63888228dc81ca60d69e1@313030303030303030303030303030303030303030"
        )
