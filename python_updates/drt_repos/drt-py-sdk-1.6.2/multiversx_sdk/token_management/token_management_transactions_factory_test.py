...
def test_create_transaction_for_freezing():
    ...
    assert (
        transaction.data.decode()
        == "freeze@4652414e4b2d313163653365@1e8a8b6b49de5b7be10aaa158a5a6a4abb4b56cc08f524bb5e6cd5f211ad3e13"
    )
    assert transaction.sender == frank
    assert transaction.value == 0
...
def test_create_transaction_for_unfreezing():
    ...
    assert (
        transaction.data.decode()
        == "unFreeze@4652414e4b2d313163653365@1e8a8b6b49de5b7be10aaa158a5a6a4abb4b56cc08f524bb5e6cd5f211ad3e13"
    )
    assert transaction.sender == frank
    assert transaction.value == 0
...
def test_create_transaction_for_wiping():
    ...
    assert (
        transaction.data.decode()
        == "wipe@4652414e4b2d313163653365@1e8a8b6b49de5b7be10aaa158a5a6a4abb4b56cc08f524bb5e6cd5f211ad3e13"
    )
    assert transaction.sender == frank
    assert transaction.value == 0
