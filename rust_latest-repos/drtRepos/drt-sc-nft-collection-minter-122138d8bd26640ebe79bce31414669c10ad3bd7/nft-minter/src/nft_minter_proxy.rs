    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn issue_token_for_brand<
        ...
        Arg4: ProxyArg<u64>,
        Arg5: ProxyArg<u64>,
        Arg6: ProxyArg<RewaOrDcdtTokenIdentifier<Env::Api>>,
    ...
    pub fn claim_royalties(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValue2<BigUint<Env::Api>, ManagedVec<Env::Api, DcdtTokenPayment<Env::Api>>>> {
        self.wrapped_tx
            .payment(NotPayable)
    ...
    pub fn accumulated_royalties(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValueEncoded<Env::Api, MultiValue2<RewaOrDcdtTokenIdentifier<Env::Api>, BigUint<Env::Api>>>> {
        self.wrapped_tx
            .payment(NotPayable)
    ...
    pub fn claim_royalties_from_marketplace<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<MultiValueEncoded<Env::Api, RewaOrDcdtTokenIdentifier<Env::Api>>>,
    >(
        self,
...
where
    Api: ManagedTypeApi,
{
    pub token_id: RewaOrDcdtTokenIdentifier<Api>,
