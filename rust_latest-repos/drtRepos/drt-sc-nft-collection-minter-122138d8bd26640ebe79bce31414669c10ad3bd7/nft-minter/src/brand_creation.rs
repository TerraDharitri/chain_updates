...
const NFT_ISSUE_COST: u64 = 50_000_000_000_000_000; // 0.05 REWA
    ...
    + crate::events::EventsModule
{
    ...
    fn issue_token_for_brand(
        ...
        mint_price_token_id: RewaOrDcdtTokenIdentifier,
        ...
        require!(
            ...
            "Invalid payment amount. Issue costs exactly 0.05 REWA"
        );
