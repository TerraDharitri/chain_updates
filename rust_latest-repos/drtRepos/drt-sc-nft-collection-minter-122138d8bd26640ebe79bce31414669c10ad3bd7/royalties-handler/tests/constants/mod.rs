...
pub const DCDT_SYSTEM_SC_ADDRESS_ARRAY: [u8; 32] = dharitri_sc::hex_literal::hex!(
    "000000000000000000010000000000000000000000000000000000000002ffff"
);
pub const ISSUE_COST: u64 = 50_000_000_000_000_000;
pub const OWNER_REWA_BALANCE: u64 = 150_000_000_000_000_000;
pub const USER_REWA_BALANCE: u64 = 1_000_000_000;
...
pub const FIRST_MINT_PRICE_TOKEN_ID: &[u8] = REWA_TOKEN_ID;
...
pub const SECOND_MINT_PRICE_TOKEN_ID: &[u8] = REWA_TOKEN_ID;
...
pub const ROYALTIES_TOKEN_ID: &[u8] = b"ROYAL-123456";
pub const ROYALTIES_TOKEN_BALANCE: u64 = 500_000_000;
pub const MINT_PAYMENTS_BALANCE: u64 = 1_000_000_000;
