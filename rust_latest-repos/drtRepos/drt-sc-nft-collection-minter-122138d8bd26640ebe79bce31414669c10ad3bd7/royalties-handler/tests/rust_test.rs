...
use constants::*;
use dharitri_sc::types::{DcdtTokenPayment, ManagedVec};
...
fn claim_payments_test() {
    ...
    // check balance
    rh_setup.b_mock.check_dcdt_balance(
        rh_setup.rh_wrapper.address_ref(),
        ROYALTIES_TOKEN_ID,
        &rust_biguint!(ROYALTIES_TOKEN_BALANCE),
    );
    rh_setup.b_mock.check_rewa_balance(
        rh_setup.rh_wrapper.address_ref(),
    ...
    rh_setup
        ...
        .execute_query(&rh_setup.rh_wrapper, |sc| {
            ...
            assert!(sc
                .known_tokens()
                .contains(&managed_token_id!(REWA_TOKEN_ID)));
            ...
            assert_eq!(
                sc.balance_for_token(&managed_token_id!(REWA_TOKEN_ID))
                    .get(),
        ...
        .execute_query(&rh_setup.rh_wrapper, |sc| {
            ...
            assert_eq!(
                ...
                RewardEntry::<DebugApi> {
                    rewa_amount: managed_biguint!(MINT_PAYMENTS_BALANCE / 3),
                    dcdt_payments: ManagedVec::from_single_item(DcdtTokenPayment::<DebugApi>::new(
                        managed_token_id!(ROYALTIES_TOKEN_ID).unwrap_dcdt(),
                        0,
...
fn claim_rewards_test() {
    ...
    rh_setup
        .b_mock
        .check_rewa_balance(&first_sh, &rust_biguint!(MINT_PAYMENTS_BALANCE / 3));
    ...
    rh_setup
        .b_mock
        .check_rewa_balance(&second_sh, &rust_biguint!(MINT_PAYMENTS_BALANCE / 3));
    ...
    rh_setup
        .b_mock
        .check_rewa_balance(&third_sh, &rust_biguint!(MINT_PAYMENTS_BALANCE / 3));
