...
use dharitri_sc::types::{BigInt, DcdtLocalRole, MultiValueEncoded};
...
use lkmoa_transfer::LkmoaTransfer;
...
pub static BASE_ASSET_TOKEN_ID: &[u8] = b"-123456";
...
fn transfer_locked_token_test() {
    ...
    // transfer half of the LKMOA to other user
    b_mock
        .execute_dcdt_transfer(
            &user_addr,
            &transfer_sc_wrapper,
...
fn transfer_cooldowns_test() {
    ...
    // user 1 transfer half of the X to the receiver
    b_mock
        .execute_dcdt_transfer(
            &user_addr,
            &transfer_sc_wrapper,
    ...
    // user 2 transfer half of the X to the receiver
    ...
    // transfer user 1 rest of the X to receiver 2
