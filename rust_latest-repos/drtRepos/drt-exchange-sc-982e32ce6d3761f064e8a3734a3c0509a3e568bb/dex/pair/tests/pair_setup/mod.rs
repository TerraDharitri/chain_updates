...
use dharitri_sc::types::{
    Address, BigUint, DcdtLocalRole, DcdtTokenPayment, ManagedAddress, MultiValueEncoded,
};
...
pub const USER_TOTAL__TOKENS: u64 = 5_000_000_000;
pub const USER_TOTAL_WREWA_TOKENS: u64 = 5_000_000_000;
    ...
    PairObjBuilder: 'static + Copy + Fn() -> pair::ContractObj<DebugApi>,
{
    pub fn new(pair_builder: PairObjBuilder) -> Self {
        ...
        b_mock
            .execute_tx(&owner_addr, &pair_wrapper, &rust_zero, |sc| {
                ...
                let second_token_id = managed_token_id!(_TOKEN_ID);
    ...
    pub fn add_liquidity(
        ...
        self.b_mock
            .execute_dcdt_multi_transfer(&self.user_address, &self.pair_wrapper, &payments, |sc| {
                ...
                assert_eq!(payments.2.token_identifier, managed_token_id!(_TOKEN_ID));
    ...
    pub fn swap_fixed_output(
        ...
        let initial_payment_token_balance =
            self.b_mock
                .get_dcdt_balance(&self.user_address, payment_token_id, 0);
        let initial_desired_token_balance =
            self.b_mock
                .get_dcdt_balance(&self.user_address, desired_token_id, 0);
    ...
    pub fn check_safe_price(
        ...
        let _ = self.b_mock.execute_query(&self.pair_wrapper, |sc| {
            let input_payment = DcdtTokenPayment::new(
