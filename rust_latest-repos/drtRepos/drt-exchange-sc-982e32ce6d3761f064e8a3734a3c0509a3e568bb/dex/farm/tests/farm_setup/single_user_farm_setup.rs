...
use dharitri_sc::types::{Address, DcdtLocalRole, ManagedAddress, MultiValueEncoded};
...
pub const _TOKEN_ID: &[u8] = b"-abcdef"; // reward token ID
...
pub const LOCKED_TOKEN_ID: &[u8] = b"X-123456";
    ...
    PairObjBuilder: 'static + Copy + Fn() -> pair::ContractObj<DebugApi>,
{
    pub fn new(farm_builder: FarmObjBuilder, pair_builder: PairObjBuilder) -> Self {
        ...
        blockchain_wrapper
            .execute_tx(&owner_addr, &farm_wrapper, &rust_zero, |sc| {
                let reward_token_id = managed_token_id!(_TOKEN_ID);
    ...
    pub fn enter_farm(
        ...
        b_mock
            .execute_dcdt_multi_transfer(&self.user_address, &self.farm_wrapper, &payments, |sc| {
    ...
    pub fn exit_farm(
        ...
        b_mock.check_dcdt_balance(&self.user_address, _TOKEN_ID, expected_user_moa_balance);
