...
_TOKEN_ID="0x4d45582d373631343430"
...
propose() {
    drtpy --verbose contract call ${CONTRACT_ADDRESS} --recall-nonce \
        ...
        --arguments ${_TOKEN_ID} ${PROPOSE_TRANSFER_AMOUNT} 0x70726f706f7365 ${PROPOSE_ARGS} \
        --send || return
}
...
upvote() {
    drtpy --verbose contract call ${CONTRACT_ADDRESS} --recall-nonce \
        ...
        --proxy=${PROXY} --chain=${CHAIN_ID} \
        --function="DCDTTransfer" \
        --arguments ${_TOKEN_ID} ${PROPOSE_TRANSFER_AMOUNT} 0x7570766f7465 $1 \
        --send || return
}
...
downvote() {
    drtpy --verbose contract call ${CONTRACT_ADDRESS} --recall-nonce \
        ...
        --proxy=${PROXY} --chain=${CHAIN_ID} \
        --function="DCDTTransfer" \
        --arguments ${_TOKEN_ID} ${PROPOSE_TRANSFER_AMOUNT} 0x646f776e766f7465 $1 \
        --send || return
}
