    ...
    PairObjBuilder: 'static + Copy + Fn() -> pair::ContractObj<DebugApi>,
{
    ...
    b_mock.set_dcdt_balance(
        &temp_user_addr,
        WREWA_TOKEN_ID,
        &rust_biguint!(USER_TOTAL_WREWA_TOKENS * 2),
    );
    b_mock.set_dcdt_balance(
        &temp_user_addr,
        RIDE_TOKEN_ID,
    ...
    PairObjBuilder: 'static + Copy + Fn() -> pair::ContractObj<DebugApi>,
{
    ...
    b_mock
        .execute_dcdt_multi_transfer(user_address, pair_wrapper, &payments, |sc| {
    ...
    b_mock
        .execute_tx(owner_addr, &energy_factory_wrapper, &rust_zero, |sc| {
            ...
            sc.base_asset_token_id()
                .set(managed_token_id!(_TOKEN_ID));
            sc.locked_token()
    ...
    FarmObjBuilder: 'static + Copy + Fn() -> farm_with_locked_rewards::ContractObj<DebugApi>,
{
    ...
    b_mock
        .execute_dcdt_multi_transfer(user_address, farm_wrapper, &payments, |sc| {
