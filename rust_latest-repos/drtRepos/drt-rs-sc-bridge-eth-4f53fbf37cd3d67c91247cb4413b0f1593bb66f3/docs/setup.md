...
You can find more about how to issue an DCDT token here: https://docs.dharitri.org/tokens/dcdt-tokens/#issuance-of-fungible-dcdt-tokens  

Next, we're going to setup the main "controller" contract, which will be a multisig-style SC. You can find more details about this type of smart contract here: https://github.com/TerraDharitri/drt-rs-sdk/blob/main/contracts/examples/multisig/README.md  
...
Requires having local MINT and local BURN roles for the WrappedRewa token. More info about how to set local roles can be found here: https://docs.dharitri.org/tokens/dcdt-tokens/#setting-and-unsetting-special-roles
