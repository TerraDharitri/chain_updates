...
'set-roles-on-dcdt-safe-eth')
  confirmation set-roles-on-dcdt-safe-eth
  ;;
...
'set-roles-on-dcdt-safe-bsc')
  confirmation set-roles-on-dcdt-safe-bsc
  ;;
...
*)
  ...
  echo " -----------"
  echo " 1.7 set-roles-on-dcdt-safe-eth"
  echo -e
  echo "PART 2 - BSC:"
  ...
  echo " -----------"
  echo " 2.6 set-roles-on-dcdt-safe-bsc"
  echo -e
